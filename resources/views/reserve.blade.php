...
<div class="container formReserve">
	<div class="row">
		...
		<div class="col-md-8 col-lg-8">
			<h3>Reserve Now!</h3>
				<form method="post" action="{{ route('create.reserve')}}">
					<fieldset>
						{{ csrf_field() }}
						<div>
							<label>Cabang</label>
                  ...
                  <input type="text" name="Harga" disabled></input> --}}
             			 <button class="btn btn-primary" type="submit" name="reservasi" style="margin-top:20px;">Reservasi</button>
					</fieldset>
				</form>
     ...
     $('select[name="kategori"]').on('change',function(){
       console.log("sukses");
        ...
        if(id_kategori) {
            $.ajax({
              type:'get',
              url:'{!!URL::to('findLayananKategori')!!}',
              data:{'id':id_kategori},
              dataType: "json",
              success:function(data) {
